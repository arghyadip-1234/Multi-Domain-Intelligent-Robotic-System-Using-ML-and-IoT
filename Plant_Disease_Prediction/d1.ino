...
// Define GPIO pins for motor control using Wemos D1 Mini
const int PWM_A = 14;  // GPIO5
const int PWM_B = 12;  // GPIO4
const int DIR_A = 0;  // GPIO0
const int DIR_B = 2;  // GPIO2
...
void loop() {
    ...
    server.handleClient();        // listen for HTTP requests from clients
      ...
      // else if (command == "G") TurnLeft();
      // else if (command == "H") TurnLeft();
      // else if (command == "I") TurnRight();
      // else if (command == "J") TurnRight();
